...
func ReturnList(ctx *gin.Context, data interface{}, total int64) {
...
func ReturnSucc(ctx *gin.Context, data interface{}) {
	ApiJsonReturn(ctx, 20000, "success", data)
}

func ReturnFail(ctx *gin.Context, msg string) {
	ApiJsonReturn(ctx, 50010, msg, nil)
}

func ReturnFailMessage(ctx *gin.Context, msg string) {
	ApiJsonReturn(ctx, 50013, msg, nil)
}

func ReturnFailCode(ctx *gin.Context, code int, msg string) {
